...
$web3 = new Web3('https://eth-mainnet.g.alchemy.com/v2/swE9yoWrnP9EzbOKdPsJD2Hk0yb3-kDr');
...
function getPendingTransactions($web3) {
    ...
    $web3->eth->getBlockByNumber('pending', true, function ($err, $block) use (&$pendingTransactions) {
        if ($err !== null) {
